...
object Dependencies {
  ...
  val akkaMultiTestkit = "com.typesafe.akka"          %% "akka-multi-node-testkit"  % akkaVersion       % Test
  ...
  val rootDependencies = Seq(akkaActor, akkaCluster, akkaClusterSeed, akkaHttp, akkaMetrics, akkaRemote, akkaSprayJson, akkaStream, akkaStreamKafka,
                             ...
                             akkaHttpTestkit, akkaMultiTestkit, akkaTestkit, embeddedKafka, scalacheck, scalatest,
                             guava, jacksonCore, kafkaClients)

  val analysisDependencies = Seq(scopt)
